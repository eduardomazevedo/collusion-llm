...
rclone copyto collusion-llm:/data/compustat/compustat-us.csv.zip ./data/raw/compustat/compustat_us.csv.zip
...
rclone copyto collusion-llm:/data/compustat/compustat-global.csv.zip ./data/raw/compustat/compustat_global.csv.zip
