...
The time period 2012-2016 was selected based on the LLM's output. Over the
entire database spanning from 2002 to 2025, there are 25 LLM-flagged
GOL transcripts (score of at least 75) and 20 of those occurred in 2012-2016 with
only one over 2017-2021 and four during 2022-2023.\footnote{%
...
occurred during 2012-2016.\footnote{%
...
transcripts with six of them over 2012-2016 (of which three are LLM-validated)
and two in 2017 (of which one is LLM-validated). In sum, the LLM\ is
identifying a large number of suspicious announcements during 2012-2016, none
...
market outcomes and they are continuing to practice capacity discipline.
...
\item GOL and LATAM are staying the course of capacity discipline,
...
During public announcements spanning 2012-2016, GOL and LATAM
...
They used variation in the content of earnings calls across markets and
...
correlated with lower capacity for that route in the ensuing quarter.}
...
\footnote{%
Inspection of earnings calls from 2022-2023 shows a resurgence of
disconcerting content. There were four LLM-flagged GOL transcripts and three
of them had relevant content. ``GOL have led the market towards
rationality. The industry has demonstrated an even higher level of
rationality in comparison to what we have seen so far.'' (2022/03/14, mean score 
= 74.17) ``We're being very disciplined on
...
a rational behavior in terms of fares.'' (2022/07/28, mean score = 76.25) ``We want to create the right equilibrium
...
in the market.'' (2023/07/27, mean score = 65). % TODO: investigate whether this transcript should be discussed here given the surrounding sentence refers to LLM-flagged transcripts.
}
