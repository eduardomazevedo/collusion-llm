...
The following three earnings calls tagged as collusive by the LLM capture the gist of our findings. The first example shows that LLM search can correctly discover collusive communications. Smithfield Foods is the world largest pork producer. In Smithfield's Q4 2009 earnings call, CEO Larry Pope stated:
...
The second exmple shows that the LLM search can find collusive communications that were not previously known in the literature. Gol is Brazil's largest domestic airline. In a 2014 investor call, executies stated:
