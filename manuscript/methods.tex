...
prompts and experimented with different LLM models (see supplementary 
information). We ultimately selected \textit{gpt-4o-mini-2024-07-18} (temperature=1.0) and the following zero-shot prompt:
\begin{quote}
...
competition and evaluating the performance of an LLM as a screen for enforcers.
 The audit procedure is described in detail in section \ref{sec:audit}.