...
\node (valid)  [below=of flag] {LLM-validated transcripts\\10-query avg $\ge 75$\\\small(\textit{N = \data{summary_stats/tagging_performance/llm_validation_tagged_int}})};
\node (audit)  [below=of valid] {Human-audited\\LLM-flagged transcripts\\\small(\textit{N = \data{summary_stats/tagging_performance/human_audit_sample_count_int}})};
